/* [INICIO: UI_HEADER_IMPORTS] - Importações e Variáveis Globais */
// Variável global para o gráfico do Chart.js
let myFluxoChart = null; 
/* [FIM: UI_HEADER_IMPORTS] */


/* [INICIO: UI_HELPER_FUNCTIONS] - Funções auxiliares de DOM */
// Evita erro se o elemento não existir ao tentar mudar o texto
function safeSetText(id, text) {
    const el = document.getElementById(id);
    if (el) el.innerText = text;
}

// Evita erro se o elemento não existir ao tentar mudar o HTML
...
/* [FIM: UI_HELPER_FUNCTIONS] */


/* [INICIO: UI_DASHBOARD_POPULATE] - Preenche o filtro de anos */
...
/* [FIM: UI_DASHBOARD_POPULATE] */


/* [INICIO: UI_DASHBOARD_UPDATE] - Lógica principal de cálculo do Dashboard */
...
/* [FIM: UI_DASHBOARD_UPDATE] */


/* [INICIO: UI_RENDER_KANBAN] */
...
/* [FIM: UI_RENDER_KANBAN] */


/* [INICIO: UI_RENDER_CLIENTES] */
...
export function renderContratos(dbState) {
    ...
    lista.innerHTML = contratosFiltrados.length === 0 
        ...
        : contratosFiltrados.map(contrato => {
            ...
            let restanteClass = restante > 0 ? 'text-red-600' : (valorTotal > 0 ? 'text-green-600' : 'text-gray-500');
...
/* [FIM: UI_RENDER_FOTOGRAFOS] */


/* [INICIO: UI_RENDER_FINANCEIRO] */
...
/* [FIM: UI_RENDER_FINANCEIRO] */


/* [INICIO: UI_RENDER_CUSTOS] */
...
/* [FIM: UI_RENDER_CONTAS_RECEBER] */


/* [INICIO: UI_CHART_FLUXO] */
...
/* [FIM: UI_RENDER_CALENDARIO] */


/* [INICIO: UI_POPULATE_SELECTS] */
...
// ESTA É A FUNÇÃO DO CONTRATO QUE ESTAVA FALHANDO
...
export function showSection(sectionId, dbState, calendarioData) {
    ...
    if (section) {
        ...
        // Renderização forçada para Financeiro (corrige gráficos)
...
export function openAddPaymentModal(contratoId = null) {
    ...
    if (contratoId) document.getElementById('payment-contrato-id').value = contratoId;
}
...
/* [FIM: UI_DELIVERY_VIEW] */


/* [INICIO: UI_CONFIG_TEMPLATES] */
...
/* [FIM: UI_CONFIG_TEMPLATES] */


/* [INICIO: UI_CONFIG_PACKAGES] */
